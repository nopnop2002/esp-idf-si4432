# VCP Example   
This is si4432 and VCP(Virtual Com Port) gateway application.   
...
```
            +------------+          +------------+          +------------+
            | VCP device |          |            |          |            |           |
            |Arduino Uno |--(USB)-->|    ESP32   |--(SPI)-->|   si4432   |==(Radio)==>
            |Arduino Mega|          |            |          |            |
            +------------+          +------------+          +------------+

            +------------+          +------------+          +------------+
            |            |          |            |          | VCP device |
==(Radio)==>|   si4432   |--(SPI)-->|    ESP32   |--(USB)-->|Arduino Uno |
            |            |          |            |          |Arduino Mega|
            +------------+          +------------+          +------------+
```
...
# Configuration
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/8f97a63e-8abf-4f12-93af-a8f1f9d413ec" />
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/6d3ab974-71cc-46e4-95e5-98034bea4b71" />
...
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/4b57c5f9-8a90-434b-899d-b46b3f354f87" />
...
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/9e29f90e-0935-40ac-b327-4850c2df37a6" />

## VCP Setting

<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/7b484955-bcd9-4701-92a5-2fb559bc8a26" />
