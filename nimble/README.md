# BLE Example   
This is si4432 and BLE gateway application.   
...
```
            +------------+          +------------+          +------------+
            |            |          |            |          |            |
            | Smartphone |--(BLE)-->|   ESP32    |--(SPI)-->|   si4432   |==(Radio)==>
            |            |          |            |          |            |
            +------------+          +------------+          +------------+

            +------------+          +------------+          +------------+
            |            |          |            |          |            |
==(Radio)==>|   si4432   |--(SPI)-->|   ESP32    |--(BLE)-->| Smartphone |
            |            |          |            |          |            |
            +------------+          +------------+          +------------+
```
...
# Configuration
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/3e4fe260-24c2-4a1f-8e32-2e5f64f560a1" />
...
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/beda1406-29f2-42e9-8792-de6bd2f871a7" />
...
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/7b5c05d0-fd4f-452c-b57d-e9d1c0d01d2c" />
